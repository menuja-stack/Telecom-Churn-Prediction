...
# ==========================================
    ...
    # ... (Keep your existing input_data creation code) ...
    # ... (Keep your existing Scaling code) ...
    ...
    if prediction == 1:
        ...
        suggestions_dict = {
            ...
            'PaymentMethod_Electronic check': "📝 **Payment Friction:** Electronic checks fail often. Suggest switching to **Auto-Pay (Credit Card)** for a $5 discount.",
